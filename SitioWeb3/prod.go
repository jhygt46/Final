...
func main() {
	...
	*/
	...
	log.Fatal(fasthttp.ListenAndServeTLS(":443", "/etc/letsencrypt/live/www.draescorza.cl/fullchain.pem", "/etc/letsencrypt/live/www.draescorza.cl/privkey.pem", requestHandler))
}
